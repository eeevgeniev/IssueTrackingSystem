    ...
    httpRequest.factory('Requests', ['$http', '$q', 'Urls', 'EncodeURIComponent', 'Headers',
        function ($http, $q, Urls, EncodeURIComponent, Headers) {
            ...
            requests.getIssue = function getIssue(token, id) {
                ...
                var promise = httpRequest(Urls.DefaultUrl + Urls.GetIssue + id, header, 'GET', null);
            ...
            requests.updateIssue = function updateIssue(token, id, issue) {
                ...
                var promise = httpRequest(Urls.DefaultUrl + Urls.UpdateIssue + id, header, 'PUT', issue);
            ...
            requests.getProject = function getProject(token, id) {
                ...
                var promise = httpRequest(Urls.DefaultUrl + Urls.GetProject + id, header, 'GET', null);
            ...
            requests.newProject = function newProject(token, project) {
                ...
                var promise = httpRequest(Urls.DefaultUrl + Urls.NewProject, header, 'POST', project);
            ...
            requests.editProject = function editProject(token, id, project) {
                ...
                var promise = httpRequest(Urls.DefaultUrl + Urls.UpdateProject + id, header, 'PUT', project);
